...
namespace GUI
{
    public partial class frmExportBills : Form
    {
        ...
        private void btnInsert_Click(object sender, System.EventArgs e)
        {
            ...
            float tong;
            if (float.TryParse(dalHDX.GetFieldValues("Select HDX_TongTien from HOA_DON_XUAT where HDX_Ma = '" + txtIDExprotBill.Text + "'"), out tong))
            {
                // Tiếp tục xử lý dựa trên giá trị 'tong' đã chuyển đổi thành công
            }
            else
            {
                // Xử lý trường hợp không thể chuyển đổi giá trị sang kiểu float
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:B1"].Value = "Hệ thống quản lý đồng hồ Minh Mạnh Mẽ";
            exRange.Range["A2:B2"].MergeCells = true;
            exRange.Range["A2:B2"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A2:B2"].Value = "Cần Thơ";
            exRange.Range["A3:B3"].MergeCells = true;
            exRange.Range["A3:B3"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A3:B3"].Value = "Điện thoại: 0853675166";
