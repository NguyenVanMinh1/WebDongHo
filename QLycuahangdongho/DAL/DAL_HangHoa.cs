...
namespace DAL
{
    public class DAL_HangHoa 
    {
        ...
        public DataTable ListProduct() // danh sách sản phẩm
        {
            SqlConnection conn = new SqlConnection(stringConnect);
            try
            {
                conn.Open();// mở chuỗi kết nối , truy vấn
                // hiện thị toàn bộ danh sách
        ...
        public bool InsertProduct(DTO_HangHoa product) // thêm , tuyền vào tham số ở dưới
        {
            SqlConnection conn = new SqlConnection(stringConnect);
            try
            {
                ...
                comd.Parameters.AddWithValue("mahang", product.Hh_Ma);// giá trị của hàng hoá product
